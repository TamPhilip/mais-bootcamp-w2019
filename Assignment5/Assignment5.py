...
Original file is located at
    https://colab.research.google.com/drive/1m_QY8Ml5pQZ3RlC1DyPMkVi7TuW6FL6Z
...
X = pd.read_csv('gdrive/My Drive/modified_mnist_x.csv', dtype=np.float32)
y = pd.read_csv('gdrive/My Drive/modified_mnist_y.csv', dtype=np.float32)
